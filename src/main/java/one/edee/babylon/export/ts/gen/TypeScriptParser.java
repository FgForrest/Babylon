// Generated from /www/p_java/babylon/src/main/java/one/edee/babylon/export/ts/gen/TypeScriptParser.g4 by ANTLR 4.13.1
package one.edee.babylon.export.ts.gen;
import one.edee.babylon.export.ts.TypeScriptParserBase;
